...
{0x00000222, 0x22000022, 0x22200000},
...
{0x00220000, 0x00000000, 0x00002200},
{0x00200000, 0x00000000, 0x00000200},
{0x02000000, 0x00000000, 0x00000020},
{0x02000000, 0x00000000, 0x00000020},
...
int main()
{
	...
	while(!game_over){
		...
		draw_bitmap(XPAR_VGA_PERIPH_MEM_0_S_AXI_MEM0_BASEADDR, spaceship_x+119, SHIP_Y-7, player_bitmap);
